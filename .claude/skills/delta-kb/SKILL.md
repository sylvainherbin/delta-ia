...
1. `.venv/bin/python scripts/catalogue.py lots --perimetre claude` liste les lots dans l'ordre : une catégorie, ou une demi-catégorie (`parametres:1`, `parametres:2`…) quand elle est grande.
